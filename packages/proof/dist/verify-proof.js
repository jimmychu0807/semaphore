...
import { requireDefined, requireObject, requireNumber, requireString, requireArray } from '@zk-kit/utils/error-handlers';
import { unpackGroth16Proof } from '@zk-kit/utils/proof-packing';
import { groth16 } from 'snarkjs';
import hash from './hash.js';
import verificationKeys from './verification-keys.json.js';
